...
(function() {
    ...
    Util.getLastTextNodeUpTo = function(n) {
        //william fix:Uncaught TypeError: Cannot read property 'nodeType' of undefined
...
//            this.editor.element.css(location);
        ...
        Annotator.prototype.onEditorHide = function(annotation) {
            this.publish('annotationEditorHidden', [this.editor, annotation]);
        ...
        Annotator.prototype.onAdderClick = function(event, location) {
            var annotation, cancel, cleanup, position, save;

            // If location exists then consider it as image annotation.
            // Else, condition is applicable to text annotation. 
            if (event != null && !location) {
                event.preventDefault();
                position = this.adder.position();
                this.adder.hide();
            }else if (event != null && location) {
            	position = location;
            }
            ...
            // Prepare the annotorious annotation. It requires src and shapes.

        	annotation.src = event.src,
        	annotation.shapes = event.shapes;
    ...
    Annotator.Widget = (function(_super) {
        ...
        Widget.prototype.checkOrientation = function() {
            ...
            // Show editor always below annotation
    ...
    Annotator.Editor = (function(_super) {
        ...
        Editor.prototype.hide = function(event) {
            ...
            return this.publish('hide', [this.annotation]);
        };
        ...
        Editor.prototype.processKeypress = function(event) {
            if (event.keyCode === 27) {
                ...
                //PavaniKa (01/28/2015) - commented this to avoid accidental submits
                //on pressing Enter key in TextAreas.
                //return this.submit();
            }
        };
    ...
    Annotator.Plugin.Store = (function(_super) {
        ...
        Store.prototype.updateAnnotation = function(annotation, data, isCreated) {
            if (__indexOf.call(this.annotations, annotation) < 0) {
            ...
            if(typeof isCreated === "boolean"){
                if(isCreated){
                	...
                	this.annotator.publish('annotationUpdatedOnServer', annotation);
                }
            }
...
/*            username = this.options.userString(annotation.user);
    ...
    Annotator.prototype.setupPlugins = function(config, options) {
        ...
        plugins = ['Unsupported', 'Auth', 'Tags', 'Filter', 'Store'];
        if (win.Showdown) {
...
var i18n_dict = {
    ...
    "error"                    : "Error",
    'errata'                   : "Stuck",
    "destacat"                 : "Mark Applied",
    "subratllat"               : "Add Note",
    "clearstuck"               : "Stuck Cleared",
