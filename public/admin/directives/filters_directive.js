...
tbcc.directive('advertisersMultiSelect', ["FilterService", function (FilterService) {
    "use strict";
        ...
        controller: ['$scope', function ($scope) {
            ...
            $scope.selectAdvertiserItem = function (advertiser) {
                ...
                if (advertiser.selected) {
                     ...
                     */
                    FilterService.setBrandsList(brand.map(function (name) {
                        return {
                            name: angular.filterWord(name),
                            value: name,
                            selected: false
                        }
                    }));
...
tbcc.directive('companiesMultiSelect', [function () {
    "use strict";

    return {
        templateUrl: "company_directive.htm",
        restrict: "EA",
        scope: false,
        controller: ['$scope', function ($scope) {
        }],
    ...
    .run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('company_directive.htm', template);
    }]);

tbcc.directive('rolesMultiSelect', [function () {
    "use strict";

    return {
        templateUrl: "role_directive.htm",
        restrict: "EA",
        scope: false,
        controller: ['$scope', function ($scope) {
        }],
    ...
    .run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('role_directive.htm', template);
    }]);

tbcc.directive('adminsMultiSelect', [function () {
    "use strict";

    return {
        templateUrl: "admin_directive.htm",
        restrict: "EA",
        scope: false,
        controller: ['$scope', function ($scope) {
        }],
    ...
    .run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('admin_directive.htm', template);
    }]);


tbcc.directive('groupsMultiSelect', [function () {
    "use strict";

    return {
        templateUrl: "group_directive.htm",
        restrict: "EA",
        scope: false,
        controller: ['$scope', function ($scope) {
        }],
    ...
    .run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('group_directive.htm', template);
    }]);